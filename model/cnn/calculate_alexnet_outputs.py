...
Calculate outputs of the deep CNN AlexNet.
...
from calculate_alexnet_predictions import *
...
if __name__ == "__main__":
    ...
    for layer in layers:
        ...
        np.save('outputs/alexnet_{0:s}.npy'.format(layer), output_mats[layer])

    open('outputs/alexnet_row_labels.txt', 'w').write(repr(row_labels))
