function [dl_total,augmented_skeleton,dl_likelihood,dl_skeleton] = description_length(skeleton)
...
% ------------------------------------------------------------
% Modified by goker 
% I have added dl_likelihood and dl_skeleton as return parameters
