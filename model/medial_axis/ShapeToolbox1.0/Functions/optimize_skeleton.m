function final_skeleton = optimize_skeleton(starting_skeleton,shape)
...
% --------------------------------------------------
% Modified by goker, 3 May 2016
% it seemed that the return value is not set, so I added the following
% line.
final_skeleton = winning_skeleton;
